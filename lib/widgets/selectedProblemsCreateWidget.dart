...
Widget createSelectedProblemsCreateProbject(context, problems) {
  return Stack(
    children: <Widget>[
      Container(
              ...
              new Container(
                ...
                child: new Container(
                  ...
                  child: new Theme(
                    ...
                    child: new Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: problems != null
                          ? getImageOfProblem(context, problems)
                          : new Container(),
                    ),
                  ),
                ),
...
List<Widget> getImageOfProblem(context, List<Problem> problems) {
  List<Widget> widgets = [];
      ...
      .map<Widget>((problem) => Container(
            ...
            child: ClipRRect(
              ...
              child: new CachedNetworkImage(
                ...
                height: 40,
                width: 40,
                imageUrl: getImageFromServer(context, problem.imagePath),
  ...
  widgets.add(
    new IconButton(
        ...
        onPressed: () {
          ...
          navigateToProblemListPage(context);
...
Future navigateToProblemListPage(context) async {
  ...
  await problemBloc.setAllProblemsByProject(projectBloc.getCurrentProject().id);
  projectBloc.problems = problemBloc.getProblems();
  await Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => ProblemSelectionCreateListPage()));
}
