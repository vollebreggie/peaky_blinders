...
import 'package:peaky_blinders/Pages/SkillRoutineSettingList.dart';
import 'package:peaky_blinders/Pages/SkillSelectionList.dart';
import 'package:peaky_blinders/widgets/TrapeziumLeftClipper.dart';

Widget createSelectedRoutineTaskSettingSkills(context, List<Skill> skills) {
  return Stack(
    children: <Widget>[
      Container(
                  ...
                  child: new Theme(
                    ...
                    child: new Row(
                      ...
                      children: skills != null
                          ? getImageOfProblem(context, skills)
                          : new Container(),
                    ),
                  ),
                ),
...
List<Widget> getImageOfProblem(context, List<Skill> problems) {
  List<Widget> widgets = [];
      ...
      .map<Widget>((problem) => Container(
            ...
            child: ClipRRect(
              ...
              child: new CachedNetworkImage(
                ...
                height: 40,
                width: 40,
                imageUrl: getImageFromServer(context, problem.imagePathServer),
  ...
  widgets.add(
    new IconButton(
        ...
        onPressed: () {
          ...
          navigateToRoutineSettingSkillListPage(context);
          //projectBloc.syncUnselectedProblems();
        }),
  );
...
Future navigateToRoutineSettingSkillListPage(context) async {
  SkillBloc skillBloc = BlocProvider.of<SkillBloc>(context);
  RoutineSettingBloc routineBloc = BlocProvider.of<RoutineSettingBloc>(context);
  await skillBloc
      .setAllSkillsByRoutineTaskSetting(routineBloc.getRoutineTask().id);
  await Navigator.push(context,
      MaterialPageRoute(builder: (context) => SkillRoutineSettingListPage()));
}
