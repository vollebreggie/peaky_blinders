...
Widget createProjectProbemWidget(context, Problem problem) {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                ...
                fit: BoxFit.fill,
                image: NetworkImage(projectBloc
                    .getImageFromServer(problem.imagePath)),
              ),
              color: Colors.grey[900],
              borderRadius: new BorderRadius.only(
