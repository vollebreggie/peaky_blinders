...
class ProblemCreatePage extends StatefulWidget {
  @override
  _ProblemCreateState createState() => _ProblemCreateState();
}

class _ProblemCreateState extends State<ProblemCreatePage> {
          ...
          children: <Widget>[
            Container(
              ...
              child: FloatingActionButton(
                ...
                onPressed: () async {
                  final ProblemBloc problemBloc =
                      BlocProvider.of<ProblemBloc>(context);
                   await problemBloc.postProblem(_imageFile, problemBloc.getCurrentProblem());
