...
class TVUserListPage extends StatefulWidget {
  @override
  _TVUserListState createState() => _TVUserListState();
}

class _TVUserListState extends State<TVUserListPage> {
  @override
  void dispose() {
    super.dispose();
  }
          ...
          Container(
            ...
            child: Center(
              child: StreamBuilder<List<User>>(
                  stream: tvBloc.outUnselectedUser,
                  initialData: [],
                  builder: (BuildContext context,
                      AsyncSnapshot<List<User>> snapshot) {
                    tvBloc.getAllUnselectedUsers();
