...
import 'package:peaky_blinders/Pages/IntroSkillsPage.dart';
import 'package:peaky_blinders/widgets/TrapeziumClipper.dart';

class IntroProblemPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _IntroProblemPageState();
}

class _IntroProblemPageState extends State<IntroProblemPage> {
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                "What are three complex problems this master would be able to solve?",
            ...
            ButtonTheme(
              ...
              child: RaisedButton(
                  ...
                  onPressed: () async {
                    await navigateToSkillPage(context);
                  }),
            ),
          ],
        ),
  ...
  Future navigateToSkillPage(context) async {
    ...
    personalBloc
        .getCurrentMaster()
        .problems
        .add(personalBloc.createProblem(firstProblemController.text));
    personalBloc
        .getCurrentMaster()
        .problems
        .add(personalBloc.createProblem(secondProblemController.text));
    personalBloc
        .getCurrentMaster()
        .problems
        .add(personalBloc.createProblem(thirdProblemController.text));

    Navigator.pushReplacement(context,
        MaterialPageRoute(builder: (BuildContext context) => IntroSkillPage()));
