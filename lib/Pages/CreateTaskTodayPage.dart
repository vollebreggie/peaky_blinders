...
class CreateTaskTodayPage extends StatefulWidget {
  @override
  _CreateTaskTodayPageState createState() => _CreateTaskTodayPageState();
}

class _CreateTaskTodayPageState extends State<CreateTaskTodayPage> {
                                ...
                                if (snapshot.hasError) {
                                  ...
                                  if (!snapshot.hasData) {
                                    ...
                                    if (_selectedProject == null) {
                                      ProjectDropdown result = snapshot.data.first;
                                      _selectedProject = result;
                                      _image = result.imagePathServer;
                ...
                Align(
                  ...
                  child: ProgressButton(
                    ...
                    onPressed: () async {
                      ...
                      _task.userId = userBloc.getUser().id;
                      _task.projectId = project.id;
                      _task.started = DateTime.now();
                      ...
                      _task.place = milestone.tasks.length;
                      _task.milestoneId = milestone.id;
                      _task.skills = _taskBloc.selectedSkills;
                      await _taskBloc.postProjectTaskToday(_task);
