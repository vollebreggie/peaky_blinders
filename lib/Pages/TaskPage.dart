...
class _TaskPageState extends State<TaskPage> {
  ...
  Future<bool> navigateBack() async {
    if (exit) {
      exit = false;
      if (_projectBloc.selectedMilestone != null) {
        _projectBloc.selectedMilestone.tasks
            .add(_projectBloc.selectedProjectTask);
        _projectBloc.selectedProjectTask = null;
      } else {
