...
class _SkillState extends State<SkillPage> {
  ...
  Widget build(BuildContext context) {
    ...
    image = skillBloc.getCurrentSkill().imagePathServer;
    titleController.text = skillBloc.getCurrentSkill().title;
    descriptionController.text = skillBloc.getCurrentSkill().description;
  ...
  Future<bool> navigateBack() async {
    if (exit) {
      exit = false;
      await skillBloc.updateCurrentImage();
      await skillBloc.updateSkill(null, skillBloc.getCurrentSkill());
  ...
  Future getImage() async {
    ...
    await skillBloc.updateSkill(_imageFile, skillBloc.getCurrentSkill());
  }
}
