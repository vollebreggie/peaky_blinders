...
class _CurrentTaskPageState extends State<CurrentTaskPage> {
  ...
  Future changeNextTask(context) async {
  ...
  _settitleValue() {
    ...
    if (taskBloc.getTasksToday().length != 0) {
      taskBloc.getTasksToday().first.title = _titleController.text;
    }
  }
  ...
  _setDescriptionValue() {
    ...
    if (taskBloc.getTasksToday().length != 0) {
      taskBloc.getTasksToday().first.description = _descriptionController.text;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color.fromRGBO(1, 1, 1, 0.90),
                    ...
                    child: ClipShadowPath(
                      ...
                      child: Container(
                        child: new CachedNetworkImage(
                          ...
                          width: MediaQuery.of(context).size.width,
                          imageUrl: taskBloc.getImageFromProject(_image),
                          ...
                          builder: (BuildContext context,
                            ...
                            return new DropdownButton<ProjectDropdown>(
                              ...
                              onChanged: (ProjectDropdown value) async {
                                ...
                                await milestoneBloc
                                    .getDropdownMileStone(_selectedProject.id);
                                setState(() {
                              ...
                              items: snapshot.data != null
                                  ? snapshot.data
                                      .map<DropdownMenuItem<ProjectDropdown>>(
                    ...
                    child: new Theme(
                      ...
                      child: ButtonTheme(
                        ...
                        child: new StreamBuilder<List<MileStoneDropdown>>(
                          ...
                          builder: (BuildContext context,
                              AsyncSnapshot<List<MileStoneDropdown>> snapshot) {
                            if (snapshot.hasError) {
                              print(snapshot.error);
                            } else {
                              if (!snapshot.hasData) {
                                ...
                                if (_selectedMileStone == null) {
                                  if (snapshot.data.first.projectId ==
                                    ...
                                    _selectedMileStone = snapshot.data
                                        .firstWhere(
                                            (m) => m.id == _task.milestoneId);
                                  } else {
                                    _selectedMileStone = snapshot.data.first;
                                  }
                                }
                              }
                            }
                            return new DropdownButton<MileStoneDropdown>(
                              ...
                              items: snapshot.data != null
                                  ? snapshot.data
                                      .map<DropdownMenuItem<MileStoneDropdown>>(
                ...
                child: ButtonTheme(
                  ...
                  child: new DropdownButton(
                    ...
                    onChanged: (newValue) {
                      ...
                      if (taskBloc.getTasksToday().length != 0) {
                        taskBloc.getTasksToday().first.points =
                            int.parse(newValue);
                      }
                    },
