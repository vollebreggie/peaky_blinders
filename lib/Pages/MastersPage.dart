...
class MastersPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _MastersPageState();
}

class _MastersPageState extends State<MastersPage> {
  final firstMasterController = TextEditingController();
  final secondMasterController = TextEditingController();
  final thirdMasterController = TextEditingController();
  ...
  @override
  void dispose() {
    firstMasterController.dispose();
    secondMasterController.dispose();
    thirdMasterController.dispose();
    super.dispose();
  }
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                "Who are three masters of their craft that you admire?",
                    ...
                    children: <Widget>[
                      ListTile(
                        ...
                        title: TextField(
                          ...
                          controller: firstMasterController,
                          style: TextStyle(
                              color: Colors.white,
                    ...
                    children: <Widget>[
                      ListTile(
                        ...
                        title: TextField(
                          cursorColor: Colors.white,
                          textAlign: TextAlign.left,
                          controller: secondMasterController,
                          style: TextStyle(
                              color: Colors.white,
                              fontStyle: FontStyle.normal,
                              fontSize: 20),
                    ...
                    children: <Widget>[
                      ListTile(
                        ...
                        title: TextField(
                          cursorColor: Colors.white,
                          textAlign: TextAlign.left,
                          controller: thirdMasterController,
                          style: TextStyle(
                              color: Colors.white,
                              fontStyle: FontStyle.normal,
                              fontSize: 20),
  ...
  Future navigateToMasterPage(context) async {
    ...
    personalBloc
        .addMaster(personalBloc.createMaster(firstMasterController.text));
    personalBloc
        .addMaster(personalBloc.createMaster(secondMasterController.text));
    personalBloc
        .addMaster(personalBloc.createMaster(thirdMasterController.text));
    Navigator.pushReplacement(context,
        MaterialPageRoute(builder: (BuildContext context) => MasterPage()));
  }
}
